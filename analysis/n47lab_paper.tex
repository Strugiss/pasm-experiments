...
\author{
    N47Lab \\[0.3cm]
    \small\textit{Correspondence:} n47lab@proton.me \\
...
The PASM-H result (MI $= 0.722$) provides a significantly larger signal than the QMM imprint--retrieval signatures ($0.56$ bits), suggesting that the phase-anchored preparation is a more efficient probe of the hypothesized memory structure. The classical nature of the correlation (discord $< 0.01$) further distinguishes PASM from QMM, which predicts a mixture of quantum and classical memory effects. More recently, the QMM framework has been extended to cosmology: dark matter emerges as the clustering of imprint clumps in the geometry-information duality~\cite{neukart2025dm}, while dark energy arises from the saturation of Planck-cell Hilbert capacity~\cite{neukart2025de}. In this extended picture, dark matter and dark energy are two phases---gradient and potential---of the same information field, a result consistent with our interpretation of the sub-Planckian matrix as the dark matter sector.
